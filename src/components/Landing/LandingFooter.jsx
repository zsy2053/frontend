...
const LandingFooter = () => {
  return (
    <div className='bg-footerBlack flex justify-center px-16 sm:flex-row flex-col'>
      ...
      <ul className='list-none sm:justify-end sm:items-center flex sm:flex-row flex-col-reverse items-start justify-start'>
        ...
        {footerLinks.map((nav, index) => (
          <li
            className={`font-inter underline cursor-pointer text-[16px] text-white font-normal mr-12`}
            key={index + 1}
          >
