    ...
    <div className='w-full overflow-hidden h-full'>
      ...
      <div className='mt-52 mb-52 flex justify-center items-center px-4'>
        <div className={`w-full xl:max-w-[1920px]`}>
          <section
            id='description1'
            className={`flex sm:flex-row flex-col items-center w-full text-black justify-center`}
          >
            <div className='flex flex-col justify-center items-center'>
              <div className='text-purple-600 text-opacity-95 text-[80px] font-semibold text-center'>
                404
              </div>
              <div className='max-w-[567px] text-neutral-600 text-[24px] font-medium mb-12'>
                Oops! This page decided to go on vacation and didn't leave a
                forwarding address. While we track it down, you might want to
